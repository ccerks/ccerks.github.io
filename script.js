...
const translations = {
  en: {
    ...
    project1_desc: '🚀 Enterprise Multi-Tenant SaaS Backend (FastAPI, PostgreSQL, Redis, RabbitMQ). Features physical database isolation (schemas), cloud-native deployment to AWS (S3, ECS Fargate), and automated CI/CD via GitHub Actions.',
  ...
  pt: {
    ...
    project_featured: '⭐ Projeto Destaque',
    project1_desc: '🚀 Backend SaaS Multi-Tenant corporativo (FastAPI, PostgreSQL, Redis, RabbitMQ). Contém isolamento físico de schemas no banco, implantação em nuvem AWS (S3, ECS Fargate) e CI/CD automatizado via GitHub Actions.',
